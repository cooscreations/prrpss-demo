	...
	<body class="one-page" data-target="#header" data-spy="scroll" data-offset="100">
		...
		<div class="body">
			...
			<div role="main" class="main" id="home">
						...
						<ul>
							<li data-transition="fade">
								...
								<div class="tp-caption top-label"
									...
									style="z-index: 5"
									data-transform_in="y:[-300%];opacity:0;s:500;">DO YOU  WANT TO</div>
								...
								<div class="tp-caption main-label"
									...
									style="z-index: 5"
									data-mask_in="x:0px;y:0px;">GROW YOUR BUSINESS</div>
								...
								<div class="tp-caption bottom-label"
									...
									style="z-index: 5"
									data-transform_in="y:[100%];opacity:0;s:500;">without being swamped down by admin tasks?</div>
								...
								<a class="tp-caption btn btn-lg btn-primary btn-slider-action"
									...
									href="#learn"
									data-x="center" data-hoffset="0"
									data-y="center" data-voffset="['80','80','80','140']"
									data-start="2200"
									data-whitespace="nowrap"
							...
							<li data-transition="fade">
								...
								<div class="tp-caption featured-label"
									...
									style="z-index: 5"
									data-transform_in="y:[100%];s:500;"
									data-transform_out="opacity:0;s:500;">PRRPSS IS DATA DRIVEN</div>
								...
								<div class="tp-caption bottom-label"
									...
									data-elementdelay="0.05">From HR to Finance, Sales to Operations
									<br />Learn more about your business instantly</div>
				...
				<section class="section section-primary mt-0" id="learn">
					<div class="container">
						<div class="row">
							<div class="col">
											...
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													...
													<span class="thumb-info-title">
														<span class="thumb-info-inner">Tradespeople</span>
														<span class="thumb-info-type">Builders, Electricians, Plumbers</span>
													</span>
													<span class="thumb-info-action">
														<span class="thumb-info-action-icon"><i class="fas fa-plus-square"></i></span>
													</span>
												</span>
											</span>
										</a>
													...
													<div class="portfolio-title">
														<div class="row">
															<div class="portfolio-nav-all col-lg-1">
																<a href="#" data-portfolio-close><i class="fas fa-th"></i></a>
															</div>
															<div class="col-lg-10 text-center">
																<h2 class="mb-0">Tradespeople</h2>
															</div>
															<div class="portfolio-nav col-lg-1">
																<a href="#" data-portfolio-prev class="portfolio-nav-prev"><i class="fas fa-chevron-left"></i></a>
																<a href="#" data-portfolio-next class="portfolio-nav-next"><i class="fas fa-chevron-right"></i></a>
															</div>
														</div>
													</div>
											...
											<div class="row mb-5">
												<div class="col-lg-4">
													...
													<span class="img-thumbnail d-block">
														<img alt="" class="img-fluid" src="img/projects/project.jpg">
													</span>
												...
												<div class="col-lg-8">
													...
													<h5 class="mt-2">Projects, Customers, Materials and Calendar</h5>
													<p class="mt-5">Reduce mistakes and improve customer experience. Automate admin tasks and speed up your finances.</p>
													<ul class="fa-ul">
  													<li><span class="fa-li">
															<i class="fas fa-wrench"></i></span> Builders
														</li>
														<li><span class="fa-li">
															<i class="fas fa-tint"></i></span> Plumbers
														</li>
														<li><span class="fa-li">
															<i class="fas fa-bolt"></i></span> Electricians
														</li>
													</ul>

													<a href="register.php" class="btn btn-primary btn-icon"><i class="fas fa-play-circle"></i>Get Started!</a>

													<ul class="portfolio-details">
														<li>
															<h5 class="mt-2 mb-1">Recommended PRRPSS Features</h5>

															<ul class="list list-inline list-icons">
																<li class="list-inline-item"><i class="fas fa-check-circle"></i> CRM</li>
																<li class="list-inline-item"><i class="fas fa-check-circle"></i> SCM</li>
																<li class="list-inline-item"><i class="fas fa-check-circle"></i> PM</li>
																<li class="list-inline-item"><i class="fas fa-check-circle"></i> QA</li>
															</ul>
														</li>
													</ul>
											...
											<div class="row mb-5">
												<div class="col-lg-4">
													...
													<div class="owl-carousel owl-theme" data-plugin-options="{'items': 1, 'margin': 10, 'animateOut': 'fadeOut', 'autoplay': true, 'autoplayTimeout': 3000}">
														<div>
															<span class="img-thumbnail d-block">
																<img alt="" class="img-fluid" src="img/projects/project-1.jpg">
															</span>
														</div>
														<div>
															<span class="img-thumbnail d-block">
																<img alt="" class="img-fluid" src="img/projects/project-1-2.jpg">
															</span>
														</div>
													</div>
												...
												<div class="col-lg-8">
													...
													<div class="portfolio-info">
														<div class="row">
															<div class="col-lg-12 text-center">
																<ul>
																	<li>
																		<a href="#" data-tooltip data-original-title="Like"><i class="fas fa-heart"></i>14</a>
																	</li>
																	<li>
																		<i class="fas fa-calendar-alt"></i> 01 January 2017
																	</li>
																	<li>
																		<i class="fas fa-tags"></i> <a href="#">Brand</a>, <a href="#">Design</a>
																	</li>
																</ul>
															</div>
														</div>
													...
													<h5 class="mt-2">Project Description</h5>
													...
													<ul class="portfolio-details">
														<li>
															...
															<ul class="list list-inline list-icons">
																<li class="list-inline-item"><i class="fas fa-check-circle"></i> Design</li>
																<li class="list-inline-item"><i class="fas fa-check-circle"></i> HTML/CSS</li>
																<li class="list-inline-item"><i class="fas fa-check-circle"></i> Javascript</li>
																<li class="list-inline-item"><i class="fas fa-check-circle"></i> Backend</li>
															</ul>
														</li>
														<li>
										...
										<div id="popupProject3" class="popup-inline-content">
											...
											<div class="row mb-5">
												<div class="col-lg-4">
													...
													<span class="img-thumbnail d-block">
														<img alt="" class="img-fluid" src="img/projects/project-2.jpg">
													</span>
										...
										<div id="popupProject4" class="popup-inline-content">
											...
											<div class="row mb-5">
												<div class="col-lg-4">
													...
													<span class="img-thumbnail d-block">
														<img alt="" class="img-fluid" src="img/projects/project-3.jpg">
													</span>
										...
										<div id="popupProject5" class="popup-inline-content">
												...
												<div class="col">
													<div class="portfolio-title">
														<div class="row">
															...
															<div class="col-lg-10 text-center">
																<h2 class="mb-0">Three Bottles</h2>
															</div>
															<div class="portfolio-nav col-lg-1">
																<a href="#" data-portfolio-prev class="portfolio-nav-prev"><i class="fas fa-chevron-left"></i></a>
																<a href="#" data-portfolio-next class="portfolio-nav-next"><i class="fas fa-chevron-right"></i></a>
											...
											<div class="row mb-5">
												<div class="col-lg-4">
													...
													<span class="img-thumbnail d-block">
														<img alt="" class="img-fluid" src="img/projects/project-4.jpg">
													</span>
										...
										<div id="popupProject6" class="popup-inline-content">
												...
												<div class="col">
													<div class="portfolio-title">
														<div class="row">
															...
															<div class="col-lg-10 text-center">
																<h2 class="mb-0">Company T-Shirt</h2>
															</div>
															<div class="portfolio-nav col-lg-1">
																<a href="#" data-portfolio-prev class="portfolio-nav-prev"><i class="fas fa-chevron-left"></i></a>
																<a href="#" data-portfolio-next class="portfolio-nav-next"><i class="fas fa-chevron-right"></i></a>
											...
											<div class="row mb-5">
												<div class="col-lg-4">
													...
													<span class="img-thumbnail d-block">
														<img alt="" class="img-fluid" src="img/projects/project-5.jpg">
													</span>
										...
										<div id="popupProject7" class="popup-inline-content">
												...
												<div class="col">
													<div class="portfolio-title">
														<div class="row">
															...
															<div class="col-lg-10 text-center">
																<h2 class="mb-0">Mobile Mockup</h2>
															</div>
															<div class="portfolio-nav col-lg-1">
																<a href="#" data-portfolio-prev class="portfolio-nav-prev"><i class="fas fa-chevron-left"></i></a>
																<a href="#" data-portfolio-next class="portfolio-nav-next"><i class="fas fa-chevron-right"></i></a>
											...
											<div class="row mb-5">
												<div class="col-lg-4">
													...
													<span class="img-thumbnail d-block">
														<img alt="" class="img-fluid" src="img/projects/project-6.jpg">
													</span>
										...
										<div id="popupProject8" class="popup-inline-content">
											...
											<div class="row mb-5">
												<div class="col-lg-4">
													...
													<span class="img-thumbnail d-block">
														<img alt="" class="img-fluid" src="img/projects/project-7.jpg">
													</span>
				...
				<section class="parallax section section-text-light section-parallax section-center m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/parallax.jpg">
					<div class="container">
						<div class="row">
							<div class="col">
								<i class="icon-featured fas fa-comments appear-animation" data-appear-animation="bounceIn"></i>
								<h2 class="mb-0"><strong>We're excited about Porto Template</strong></h2>
								<h3 class="lead mb-4">30,000 customers in 100 countries use Porto Template. Meet our customers.</h3>
							</div>
						</div>
					</div>
				</section>
						...
						<div class="row mt-5">
							<div class="col-lg-6">
								...
								<form id="contactForm" action="php/contact-form.php" method="POST">
									...
									<div class="form-row">
										<div class="form-group col">
											<input type="submit" value="Send Message" class="btn btn-primary btn-lg mb-4" data-loading-text="Loading...">
										</div>
									</div>
								</form>
							</div>
					...
					<div class="row">
						...
						<div class="col-lg-3 col-lg-offset-1">
							...
							<ul class="list list-icons list-icons-sm">
								<li><i class="far fa-envelope"></i> <a href="mailto:okler@okler.net">okler@okler.net</a></li>
							</ul>
